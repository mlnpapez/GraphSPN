...
if __name__ == '__main__':
    ...
    for name in models:
        ...
        path = utils.train(model, loader_trn, loader_val, hyperpars, checkpoint_dir, trainepoch_dir)
        model = torch.load(path)
        metrics = utils.evaluate(model, loader_trn, loader_val, loader_tst, smiles_trn, hyperpars, evaluation_dir)
